...
<body style="padding:0px;background:#EAEEF5;">  
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:1px; "> 
        <div position="left"  title="主要菜单" id="accordion1" >
        	<security:authorize ifAnyGranted="AUTH_0101,AUTH_010101">
                   <div title="用户管理">
						<ul id="l-scoll">
							<security:authorize ifAnyGranted="AUTH_0101"><li><a href="javascript:f_addTab('AUTH_0101','系统用户','./user/user-list.do')">系统用户</a></li></security:authorize>
							<security:authorize ifAnyGranted="AUTH_010101"><li><a href="javascript:f_addTab('AUTH_010101','添加用户','./user/user-add.do')">添加用户</a></li></security:authorize>
							
						</ul>
					</div>
			</security:authorize>
			<security:authorize ifAnyGranted="AUTH_0102">
                   <div title="权限管理">
						<ul id="l-scoll">
							<security:authorize ifAnyGranted="AUTH_0102"><li><a href="javascript:f_addTab('AUTH_0102','系统角色','./role/role-list.do')">系统角色</a></li></security:authorize>
