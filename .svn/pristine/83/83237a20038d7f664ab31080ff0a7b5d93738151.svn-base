...
<body style="padding:0px;background:#EAEEF5;">  
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:1px; "> 
        <div position="left"  title="主要菜单" id="accordion1" >
        	<security:authorize ifAnyGranted="AUTH_0501,AUTH_0502">
                   <div title="公告管理">
						<ul id="l-scoll">
							<security:authorize ifAnyGranted="AUTH_0501"><li><a href="javascript:f_addTab('AUTH_0501','公告列表','./notice/notice-list.do')">公告列表</a></li></security:authorize>
							<security:authorize ifAnyGranted="AUTH_0502"><li><a href="javascript:f_addTab('AUTH_0502','添加公告','./notice/notice-add.do')">添加公告</a></li></security:authorize>
