...
<head>
	...
	var rows =null;
		$(function () {
			...
			var cfg = $.extend({}, gridConfig,{
				...
				columns: [
		                	...
		                	{ display: '组织名 ', name: 'groupName',width:'30%' },
		                	{ display: '类型', name: 'type',width:'20%',render:function(data){
		                		return getDict("GROUPTYPE",data.type);
		                	} }
		...
		function _add(){
			location.href="<%=path%>/group/group-add.do";
		}
		...
		location.href="<%=path%>/group/group-edit/"+id+".do";
...
<body>
<div class="form_page">
	<div class="form_group"><img src="<%=path %>/images/communication.gif" alt="" /><span>组织机构</span></div>
	<div class="form_content">
		...
		<table class="query_table" width="250" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td class="query_content"><span class="inputBox"><span class="bg"><input id="groupname" type="text" style="width: 150px;" /></span></span></td>
			</tr>
			<tr>
