...
<head>
	...
	var rows =null;
		$(function () {
			...
			var cfg = $.extend({}, gridConfig,{
				...
				columns: [
		                	...
		                	{ display: '发布人 ', name: 'createUser',width:'20%' },
		...
		function _openSearch(){
			if(!window["searchDlg"]){
				window["searchDlg"] = $.ligerDialog.open({target:$("#searchBox"), title:"查询", width:300});
			}else{
		...
		function _search(){
			var title = $("#title").val();
			reloadGrid(g, {"title":title});
			searchDlg.hidden();
		}
		
		function _add(){
			location.href="<%=path%>/notice/notice-add.do";
		}
		...
		location.href="<%=path%>/notice/notice-edit/"+id+".do";
...
<body>
<div class="form_page">
	<div class="form_group"><img src="<%=path %>/images/communication.gif" alt="" /><span>公告管理</span></div>
	<div class="form_content">
		<div id="searchBox" class="query_box hiden">
		<table class="query_table" width="250" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td class="query_title">标题：</td>
				<td class="query_content"><span class="inputBox"><span class="bg"><input id="title" type="text" style="width: 150px;" /></span></span></td>
			</tr>
			<tr>
